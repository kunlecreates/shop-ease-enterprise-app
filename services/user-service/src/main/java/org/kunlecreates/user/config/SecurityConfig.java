...
public class SecurityConfig {
     ...
     * This chain intercepts requests to public paths and allows them without JWT.
     * CRITICAL: This chain must NOT configure oauth2ResourceServer!
     */
    @Bean
    @Order(1)
    public SecurityFilterChain publicFilterChain(HttpSecurity http) throws Exception {
        ...
        // NO oauth2ResourceServer() here! That's what allows anonymous access.
