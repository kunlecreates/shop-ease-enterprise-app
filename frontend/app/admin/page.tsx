      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Link href="/admin/products" className="block">
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer h-full">
            ...
            <p className="text-gray-600 mb-4">Manage your product catalog, stock, and pricing</p>
        ...
        <Link href="/admin/orders" className="block">
          <div className="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow cursor-pointer h-full">
            ...
            <p className="text-gray-600 mb-4">View and manage customer orders and transactions</p>
